...
public class GameOverDialogue : ADialogue
{
    ...
    public IDialogueResult Defeat(EventDiscussion e, int lastChoiceId)
    {
        ...
        else if (_currProgress == 1) res = new NormalDialogue(true, "I usually would try to give you advice to avoid dying but with this...", FacialExpression.NEUTRAL, _knownName);
