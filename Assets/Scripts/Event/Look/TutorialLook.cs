...
namespace Event.Look
{
    public class TutorialLook : ALook
    {
        public override string GetText(string _)
        {
            ...
            {
                case Progression.BEGINNING: // If the player try to go to the human world without speaking to Etahnia
                    return "I can't remember what I'm doing here... maybe I should go speak to that girl first.";

                case Progression.ETAHNIA_KILL_INTRO: // If the player try to go back after being in Etahnia's world
