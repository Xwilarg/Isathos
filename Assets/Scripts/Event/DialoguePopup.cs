...
public class DialoguePopup : MonoBehaviour
{
    ...
    [SerializeField]
    private SO.DialogueSprites _sprites;
    ...
    public void DisplayChoices(Event.Trigger.EventType.EventDiscussion e, string[] choices)
    {
    ...
    private Sprite GetSprite(Character c, FacialExpression fe)
    {
        ...
        else if (c == Character.YUMENA) charac = _sprites.Yumena;
        if (charac == null)
